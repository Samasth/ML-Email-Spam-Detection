...
def lambda_handler(event, context):
    ...
    if event: 
        ...
        fileObj = s3.get_object(Bucket = "email-store-sna", Key=filename)
        print("file has been gotten\n")
        print(fileObj)
        #temp = json.loads(base64.b64decode(fileObj['Body']).decode('utf-8'))
        #print(temp)
        ...
        print(from_address)
        for time in b['X-Received'].split('\n'):
            received_time = time
        print(received_time)
        print(b['Subject'])
        subject = b['Subject']
        
        #print(fileObj['Body'].read())
        if b.is_multipart():
        ...
        EMAIL_HOST_USER = "AKIAUXXPI2VCOU3NDMWN" # Replace with your SMTP username
        EMAIL_HOST_PASSWORD = "BAExP2S06bcvdvwlLPKejCfkPURvJwQufG6uTWe3iyPm" # Replace with your SMTP password
        EMAIL_PORT = 587
        
        msg = MIMEMultipart('alternative')
        msg['Subject'] = "Result for EMAIL"
        msg['From'] = "info@antartic.company"
        msg['To'] = from_address
        ...
        s.sendmail("info@antartic.company", from_address, msg.as_string())
        s.quit()
